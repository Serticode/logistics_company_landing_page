...
import 'package:logistics_landing_page/services/controllers/destination_selector/to_destination_selector_controller.dart';
...
class ToDestinationSelector extends ConsumerWidget {
  const ToDestinationSelector({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final List<DestinationCountries> items = ref
        .read(toDestinationControllerProvider.notifier)
        .getAllDestinationCountries;

    final destinationCountries = ref.watch(toDestinationControllerProvider);
